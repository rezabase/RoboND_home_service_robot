...
#xterm -e "source ~/workspace/catkin_ws/devel/setup.bash; roslaunch pick_objects my_view_navigation.launch" & 
sleep 5

xterm -e "source ~/workspace/catkin_ws/devel/setup.bash; rosrun pick_objects pick_objects" & 
sleep 3

xterm -e "source ~/workspace/catkin_ws/devel/setup.bash; rosrun add_markers add_markers_home_service" & 
